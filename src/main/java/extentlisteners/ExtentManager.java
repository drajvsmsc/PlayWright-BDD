...
public class ExtentManager {
	...
	public static String fileNameSS;
	...
	public static void captureScreenshot() throws IOException {
		...
		Date d = new Date();
		fileNameSS = ".\\screenshot\\"+d.toString().replace(":", "_").replace(" ", "_") + ".jpg";

		PlaywrightDriver.getPage().screenshot(new Page.ScreenshotOptions().setPath(Paths.get(".\\reports\\"+fileNameSS)));
